...
public class AppChannelFragmentAdapter extends FragmentPagerAdapter {
    ...
    public AppChannelFragmentAdapter(FragmentManager fm, @NonNull List<ChannelEntity> channels) {
        super(fm);
